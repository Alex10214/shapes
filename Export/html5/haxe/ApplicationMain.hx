...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("MyProject", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("MyProject", null, 0, 0);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "MyProject";
		app.meta["name"] = "MyProject";
		app.meta["packageName"] = "com.sample.myproject";
